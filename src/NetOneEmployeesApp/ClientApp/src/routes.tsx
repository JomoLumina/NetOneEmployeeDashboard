  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        component: lazy(() => import('src/views/employees/EmployeeAddView'))
      },
      {
        id: 9,
        exact: true,
        path: '/app/employees/:employeeId',
        component: lazy(() => import('src/views/employees/EmployeeDetailsView'))
      },
      {
        id: 10,
        exact: true,
        path: '/app/employees/:employeeId/edit',
